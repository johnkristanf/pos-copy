...
import { CompleteOrdersActions } from "./complete-order-actions"

interface MobileCompleteOrdersCardProps {
  order: Order
}
1

export const MobileCompleteOrdersCard = ({
  order,
}: MobileCompleteOrdersCardProps) => {
  ...
  return (
    <Card className="mb-4">
      ...
      <CardHeader className="flex flex-row items-start justify-between pb-2">
        ...
        <CompleteOrdersActions order={order} />
      </CardHeader>
