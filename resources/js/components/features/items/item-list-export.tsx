...
interface ItemListDocumentProps {
  items: Item[]
  categories: Category[]
  suppliers: Supplier[]
  logo?: string | null
...
const ItemListDocument = ({
  ...
  return (
    <Document>
      ...
      >
        <USIDocsHeader logo={logo} title="ITEM LIST" />
        ...
        >
          ...
          <View style={tw("w-[8%] border-r border-gray-300 p-2")}>
            <Text style={tw("text-[8px] text-center font-bold")}>Unit</Text>
          </View>
...
export const ItemListExport = ({
  ...
  const handleDownload = () => {
    ...
    link.href = url
    link.download = `item-inventory-${new Date().toISOString().split("T")[0]}.pdf`
  ...
  return (
    <div className="w-full max-w-6xl mx-auto flex flex-col gap-6">
      <iframe
        ...
        title="Item List Export Preview"
      />
