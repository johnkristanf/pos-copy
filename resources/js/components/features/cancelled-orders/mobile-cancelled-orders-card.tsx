...
import { CancelledOrdersActions } from "./cancelled-orders-actions"

interface MobileCancelledOrdersCardProps {
  order: Order
}
1

export const MobileCancelledOrdersCard = ({
  order,
}: MobileCancelledOrdersCardProps) => {
  ...
  return (
    <Card className="mb-4">
      <CardHeader className="flex flex-row items-start justify-between pb-2">
        ...
        <CancelledOrdersActions order={order} />
      </CardHeader>
